...
gint main(gint argc, gchar **argv) {
    ...
    transform("/Users/christophekunzli/CLionProjects/gegl/potato.png");
    gegl_exit();
    return 0;
}
...
void transform(const gchar* filePath) {
    ...
    gegl = gegl_node_new();
    load = gegl_node_new_child(gegl, "operation", "gegl:png-load", "path", filePath, NULL);
    ...
    save = gegl_node_new_child(gegl, "operation", "gegl:png-save", "path", "/Users/christophekunzli/CLionProjects/gegl/out.png", NULL);
